    ...
    <section className="min-h-screen flex items-center justify-center text-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-8 relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          <a href="#work" className="group relative px-8 py-4 rounded-full font-semibold bg-white text-black shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-10px_rgba(255,255,255,0.5)] transition-all hover:-translate-y-1">
          ...
          <a href="#services" className="px-8 py-4 rounded-full font-semibold text-zinc-300 hover:text-white transition-colors flex items-center gap-2 group">
            Our Services
